...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        bool LoadFromDB(uint32 guid, SQLQueryHolder *holder, WorldSession *session);
        ...
        void LearnTalent(uint32 talentId, uint32 talentRank, bool learn = true);
    ...
    protected:
        ...
        */
        ...
        uint32 m_talentSpec[MAX_TALENT_TABS];              // tabId of the main talent branch
