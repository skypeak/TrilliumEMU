...
void Pet::SavePetToDB(PetSlot mode)
{
    ...
    if (mode >= PET_SAVE_AS_CURRENT)
    {
        ...
        ss 	<< "REPLACE INTO character_pet (id, entry,  owner, modelid, level, exp, Reactstate, slot, name, renamed, curhealth, curmana, abdata, savetime, CreatedBySpell, PetType, resettalents_cost, resettalents_time) "
            << "VALUES ("
