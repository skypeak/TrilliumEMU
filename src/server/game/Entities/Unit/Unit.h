...
enum MovementFlags
{
    ...
    MOVEMENTFLAG_MASK_MOVING =
        ...
        MOVEMENTFLAG_PITCH_UP | /*MOVEMENTFLAG_JUMPING |*/ MOVEMENTFLAG_PITCH_DOWN | MOVEMENTFLAG_FALLING | MOVEMENTFLAG_ASCENDING | MOVEMENTFLAG_DESCENDING |
...
class Unit : public WorldObject
{
    public:
        ...
        int32 GetPower(Powers power) const { return GetUInt32Value(UNIT_FIELD_POWER1 + GetPowerIndexByClass(power, getClass())); }
		...
		void SendMonsterMoveFly(float NewPosX, float NewPosY, float NewPosZ, uint32 Time, Player* player = NULL);
