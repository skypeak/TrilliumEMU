...
const std::string CustomSpellAuraOptionsfmt="ppppp";
const std::string CustomSpellAuraOptionsIndex = "Id";
const char SpellAuraRestrictionsEntryfmt[]="niiiiiiii";
const std::string CustomSpellAuraRestrictionfmt="ppppppppp";
const std::string CustomSpellAuraRestrictionIndex = "Id";
...
const std::string CustomSpellClassOptionsIndex="Id";
