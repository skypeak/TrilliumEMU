...
void OPvPCapturePointHP::ChangeState()
{
    ...
    case OBJECTIVESTATE_ALLIANCE:
        ...
        sWorld->SendZoneText(OutdoorPvPHPBuffZones[0], sObjectMgr->GetArkcoreStringForDBCLocale(HP_LANG_LOSE_A[m_TowerType]));
        break;
    case OBJECTIVESTATE_HORDE:
        ...
        sWorld->SendZoneText(OutdoorPvPHPBuffZones[0], sObjectMgr->GetArkcoreStringForDBCLocale(HP_LANG_LOSE_H[m_TowerType]));
        break;
