...
void OPvPCapturePointTF::ChangeState()
{
    ...
    if (m_OldState == OBJECTIVESTATE_ALLIANCE)
    {
        ...
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetArkcoreStringForDBCLocale(LANG_OPVP_TF_LOSE_A));
    }
    ...
    else if (m_OldState == OBJECTIVESTATE_HORDE)
    {
        ...
        sWorld->SendZoneText(OutdoorPvPTFBuffZones[0], sObjectMgr->GetArkcoreStringForDBCLocale(LANG_OPVP_TF_LOSE_H));
    }
